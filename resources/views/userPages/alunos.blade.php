...
<body class="bg-gray-50 font-sans text-gray-800">
  ...
  <section class="max-w-5xl mx-auto p-8 text-center">
    <img src="{{ asset('images/alunos/grupo.jpeg') }}" 
         alt="Foto em grupo" 
  ...
  <main class="max-w-6xl mx-auto px-6 md:px-12 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <div class="bg-white rounded-2xl shadow-md hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 p-6 text-center">
      <img src="images/alunos/kauan.jpg" alt="Kauan" class="mx-auto w-48 h-64 rounded-2xl mb-4 object-cover object-top shadow-md border-2 border-orange-400">
    ...
    <div class="bg-white rounded-2xl shadow-md hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 p-6 text-center">
      <img src="images/alunos/gu.jpg" alt="Gustavo" class="mx-auto w-48 h-64 rounded-2xl mb-4 object-cover object-top shadow-md border-2 border-orange-400">
    ...
    <div class="bg-white rounded-2xl shadow-md hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 p-6 text-center">
      <img src="images/alunos/Daniel.jpg" alt="Daniel" class="mx-auto w-48 h-64 rounded-2xl mb-4 object-cover object-top shadow-md border-2 border-orange-400">
    ...
    <div class="bg-white rounded-2xl shadow-md hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 p-6 text-center">
      <img src="images/alunos/jadon.jpg" alt="Jadon" class="mx-auto w-48 h-64 rounded-2xl mb-4 object-cover object-top shadow-md border-2 border-orange-400">
    ...
    <div class="bg-white rounded-2xl shadow-md hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 p-6 text-center">
      <img src="images/alunos/matheus.jpg" alt="Matheus" class="mx-auto w-48 h-64 rounded-2xl mb-4 object-cover object-top shadow-md border-2 border-orange-400">
    ...
    <div class="bg-white rounded-2xl shadow-md hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 p-6 text-center">
      <img src="images/alunos/du.jpg" alt="Eduardo" class="mx-auto w-48 h-64 rounded-2xl mb-4 object-cover object-top shadow-md border-2 border-orange-400">
