...
<body>
  ...
  <!-- Título alinhado à direita com espaçamento superior -->
 <div class="container2">
    <span class="color-laranja text-3xl font-semibold text-right block titles">
      Um pouco sobre a nossa história
    </span>
    <p class="text-lg text-justify color-cinza-1 text-mi sobre2">
      A Casa dos Salgados é uma empresa familiar que começou com a paixão por salgados.
      Esta empresa foi fundada a 13 anos atrás, com o objetivo de oferecer produtos de qualidade e um atendimento excepcional.
      Desde então, temos nos dedicado a criar uma variedade de salgados deliciosos, feitos com ingredientes frescos e selecionados.
    </p>
</div>
            ...
            <section class="max-width " id="about">
                <div class="container2">
                    <div class="call">
                        <div class="left">
                            <span class="color-laranja text-3xl font-semibold text-right block  ">Sobre Nós</span>
                            <p class="text-md color-cinza-1">A Casa dos Salgados é uma empresa familiar que começou com
                                a paixão
                                por salgados. Oferecemos diversos salgados excepcionais e uma experiência única para
                                todos os
